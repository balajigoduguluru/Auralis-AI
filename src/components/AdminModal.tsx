...
export default function AdminModal({ open, observations, onClose, onClear }: AdminModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} ariaLabel="Admin Observation Panel">
      <div className="p-8 md:p-12 space-y-8 relative overflow-hidden max-h-[90vh] flex flex-col">
